...
class Bot(BaseBot):
    ...
    async def on_chat(self, user: User, message: str) -> None:
            ...
            if message.startswith("!wallet") and user.username == "____Rayen____" or user.username == "superhotgirll" or user.username == "eva__63":
            ...
            if message.lower().startswith("!tipall ") and user.username == "____Rayen____" or user.username == "superhotgirll" or user.username == "eva__63":
              parts = message.split(" ")
              if len(parts) != 2:
