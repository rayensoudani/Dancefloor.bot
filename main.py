          ...
          if user.username == "superhotgirll":
            ...
            if message.lower().startswith("!tipall ") and user.username == "iced_yu":
              ...
              for room_user, pos in room_users.content:
                ...
                await self.highrise.chat(f"Dancefloor[1]configured in [{self.pos1}]")

            elif message.startswith("/dancefloor2"):

                self.pos2 = await self.get_actual_pos(user.id)
                await self.highrise.chat(f"Dancefloor[2] configured in [{self.pos2}]")
                ...
                if self.pos1 and self.pos2:
                    ...
                    await self.highrise.chat("Dancefloor created.")
                    self.pos1 = None
                    self.pos2 = None
                else:
                    await self.highrise.chat("Please set both  /dancefloor1 and /dancefloor2 first.")



            elif message.startswith("/stop dancefloor"):
